...
URKinematic::URKinematic() : RobotKinematic(std::make_shared<robot_misc::URUtility>()) { parseLinkLengths(); }

void URKinematic::calculateKinematicTransformations()
{
    ...
    _transformations[2](0, 0) = _c1;
    _transformations[2](0, 1) = -_s1;
    _transformations[2](1, 0) = _s1;
    _transformations[2](1, 1) = _c1;

    _transformations[3](0, 0) = -_s2;
    _transformations[3](0, 2) = _c2;
    _transformations[3](2, 0) = -_c2;
    _transformations[3](2, 2) = -_s2;

    _transformations[4](0, 0) = _c3;
    _transformations[4](0, 2) = _s3;
    _transformations[4](2, 0) = -_s3;
    _transformations[4](2, 2) = _c3;

    _transformations[5](0, 0) = -_s4;
    _transformations[5](0, 2) = _c4;
    _transformations[5](2, 0) = -_c4;
    _transformations[5](2, 2) = -_s4;

    _transformations[6](0, 0) = _c5;
    _transformations[6](0, 1) = -_s5;
    _transformations[6](1, 0) = _s5;
    _transformations[6](1, 1) = _c5;

    _transformations[7](0, 0) = _c6;
    _transformations[7](0, 2) = _s6;
    _transformations[7](2, 0) = -_s6;
    _transformations[7](2, 2) = _c6;
}

void URKinematic::calculateEndEffectorMatrix()
{
    ...
    forward(qd, T);
    _ee_transformation = Eigen::Map<Eigen::Matrix<double, 4, 4, Eigen::RowMajor>>(T);
...
{
    std::vector<double> link_lengths = std::vector<double>(9, 0.0);

    link_lengths[0] = _segment_structs[1].joint.tz;  // pedestal_height
    link_lengths[1] = _segment_structs[2].joint.tz;  // shoulder_height
    link_lengths[2] = _segment_structs[3].joint.ty;  // shoulder_offset
    link_lengths[3] = _segment_structs[4].joint.tz;  // upper_arm_length
    link_lengths[4] = _segment_structs[4].joint.ty;  // elbow_offset
    link_lengths[5] = _segment_structs[5].joint.tz;  // forearm_length
    link_lengths[6] = _segment_structs[6].joint.ty;  // wrist1_length
    link_lengths[7] = _segment_structs[7].joint.tz;  // wrist2_length
    link_lengths[8] = _segment_structs[8].joint.ty;  // wrist3_length

    _d1 = link_lengths[0] + link_lengths[1];                    // pedestal_height + shoulder_height;
    _a2 = link_lengths[3] * -1;                                 // upper_arm_length * -1;
    _a3 = link_lengths[5] * -1;                                 // forearm_length * -1;
    _d4 = link_lengths[2] + link_lengths[4] + link_lengths[6];  // shoulder_offset + elbow_offset + wrist1_length;
    _d5 = link_lengths[7];                                      // wrist2_length;
    _d6 = link_lengths[8];                                      // wrist3_length;

...
<html>
<head>
    <title>Past Appointments - Patient</title>
    <link rel="stylesheet" type="text/css" href="/patientPast-Appos.css">
</head>
...
<div id="past-box">
    ...
    <div class="past-table">
        ...
        <h1>Past Appointments - Patient</h1>

        <form name = "filterer" action = "/login/patient/pastAppointments" method = "post">
        ...
        <form name = "no_filterer" action = "/login/patient/pastAppointments" method = "post">
                ...
                <td>
                    <div style="height:280px; overflow:auto;">
                        <table id="table-body" cellspacing="0" cellpadding="1" border="0" style="width:100%">
                            <%! ResultSet patientPastAppos; %>
                            <% patientPastAppos = (ResultSet) request.getAttribute("Patient Past Appos");%>
                            <% while(patientPastAppos.next()) { %>
                            <tr>
                                <% for(int i = 1; i < patientPastAppos.getMetaData().getColumnCount(); i++) { %>
                                <td>
                                    <% try { %>
                                    <%= patientPastAppos.getString(i)%>
                                    <% }catch(Exception e){ %>
                                    <% e.printStackTrace();%>
                                    <% }%>
                                </td>

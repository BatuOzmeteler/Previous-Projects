...
def generate_user(number_of_users,user_type):
    ...
    for i in range(number_of_users):
        ...
        out.write('INSERT INTO Users VALUES(\'' + username + '\',\'' + fullname + '\',' + str(TC) + ',\'' + password + '\',\'' + email + '\',\'' + address + '\',' + phoneNo + ',\'' + str(ut_id) + '\');\n')
...
generate_user(50,USER.DOCTOR)
generate_user(100,USER.NURSE)
#generate_user(20,USER.PATIENT)
generate_room(100)
#generate_appointment(10)
out.close()

  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"mpclib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2799479937U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3942847027U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2018788220U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3856406776U);
        } else if (nrhs==4) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(aiChksum, "pcP5nOlS3PyES7ogb6fmWC") == 0) {
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "s3HhfPOqr7Dw0SxT1pN0pD") == 0) {

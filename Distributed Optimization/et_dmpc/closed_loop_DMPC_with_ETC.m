...
function closed_loop_DMPC_with_ETC(param, opts, t0, tf)
    ...
    pos_obs = rand(N_obs, 3)*5;     % positions of obstacles (xyz)
    ...
    for i = 2:N_sim
        ...
        etc = check_etc(param, pos_rob, pos_obs, pos_lims, div_lim,...
...
function etc = check_etc(param, pos_rob, pos_obs, pos_lims, div_lim, ...
    X_star, N_pointer, iter)

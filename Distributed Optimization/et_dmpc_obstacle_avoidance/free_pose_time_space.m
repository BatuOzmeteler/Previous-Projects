%% Calculate Free Pose-Time Space
% Authors: 
% - Shehabeldine Housein
%% Summary
% This function calculates the free pose-time space for 
% the whole horizon for every agent.
% INPUT:  t0             start time
%         T              time horizon
%         h              step size
...
%
% OUTPUT: AA, bb for each agent. AA = {AA1, AA2, ..., AA_n}, bb = {bb1, bb2, ..., bb_n}
%%

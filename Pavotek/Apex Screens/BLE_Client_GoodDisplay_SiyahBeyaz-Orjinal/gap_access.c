...
void GapSetDefaultConnParams(ble_con_params *conn_params)
{
    ...
    if(conn_params != NULL) MemCopy(&default_conn_params, conn_params, sizeof(ble_con_params));

    if(LsSetNewConnectionParamReq(&default_conn_params, 0, 0, (uint16)SCAN_INTERVAL,

...
extern bool GattWriteRequest(uint16 dev, SERVICE_FUNC_POINTERS_T *pService, uint16 char_type, uint8*, uint16);
...
#define MAX_KASA_SAYISI ((uint8)(150))
...
extern tsBoxes Boxes[MAX_KASA_SAYISI];
/*----------------------------------------------------------------------------*
 *  NAME
 *      GattDiscoveryEvent
 *
 ...
 *      Nothing
 *----------------------------------------------------------------------------*/
extern void GattDiscoveryEvent(lm_event_code event_code, LM_EVENT_T *p_event_data);
